...
"""
    ...
    parser.add_argument('--esc50_fixed_pt', type=str, default="esc50_fixed_dataset.pt",
                        help="Path to ESC50 fixed dataset pt file")
    parser.add_argument('--rir_dir', type=str, required=True, help="Directory containing RIR files (e.g. 5mic_rir)")
    parser.add_argument('--out_dir', type=str, default=None,
                        help="Output directory. If not provided, defaults to <rir_dir>_rir_convolved")
    ...
    parser.add_argument('--split', type=str, choices=['train', 'validate', 'test', 'all'], default="all",
                        help="Data split to process (train, validate, test, or all)")
    parser.add_argument('--categories', type=str, default="range(50)",
                        help="Categories as a Python expression, e.g., 'range(50)'")
